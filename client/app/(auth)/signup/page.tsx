        ...
        <div>
            <div className="flex items-center h-[600px] mx-32 justify-around">
                ...
                <div className="py-4 border-2 border-gray-300 rounded-lg px-3">
                    ...
                    <Input label="Work Email" type="email" onChange={() => { }} size="large" />
                    <div className="flex justify-between">
                        <Input label="First name" type="text" onChange={() => { }} size="small" />
                        <Input label="Last name" type="text" onChange={() => { }} size="small" />
                    </div>
